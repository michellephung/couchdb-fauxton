...
function (FauxtonAPI, ActionTypes, Resources) {
  return {
    ...
    sortByColumnHeader: function (columnName, fromClick) {
      FauxtonAPI.dispatch({
    ...
    startTimeSince: function () {
      FauxtonAPI.dispatch({
        type: ActionTypes.ACTIVE_TASKS_START_TIME_SINCE
      });
    },
    toggleTabVisibility: function () {
      FauxtonAPI.dispatch({
        type: ActionTypes.ACTIVE_TASKS_TOGGLE_FILTER_TAB
      });
    }
  };
});
